 ...
 * ```
 */
export declare function getSnippets(args: GetSnippetsArgs, opts?: pulumi.InvokeOptions): Promise<GetSnippetsResult>;
/**
 ...
 * ```
 */
export declare function getSnippetsOutput(args: GetSnippetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSnippetsResult>;
/**
 * A collection of arguments for invoking getSnippets.
 */

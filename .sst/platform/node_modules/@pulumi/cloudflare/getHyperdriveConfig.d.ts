 ...
 * ```
 */
export declare function getHyperdriveConfig(args: GetHyperdriveConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetHyperdriveConfigResult>;
/**
 ...
 * ```
 */
export declare function getHyperdriveConfigOutput(args: GetHyperdriveConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHyperdriveConfigResult>;
/**
 * A collection of arguments for invoking getHyperdriveConfig.
 */

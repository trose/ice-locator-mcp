...
export declare class ZeroTrustTunnelCloudflared extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustTunnelCloudflaredState, opts?: pulumi.CustomResourceOptions): ZeroTrustTunnelCloudflared;
    /**
     * Returns true if the given object is an instance of ZeroTrustTunnelCloudflared.  This is designed to work even

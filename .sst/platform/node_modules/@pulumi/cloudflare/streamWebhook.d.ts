 ...
 * ```
 */
export declare class StreamWebhook extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StreamWebhookState, opts?: pulumi.CustomResourceOptions): StreamWebhook;
    /**
     * Returns true if the given object is an instance of StreamWebhook.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StreamWebhook;
    /**
     ...
     */
    readonly notificationUrl: pulumi.Output<string>;
    /**

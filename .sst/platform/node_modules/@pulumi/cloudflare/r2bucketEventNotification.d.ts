 ...
 * ```
 */
export declare class R2BucketEventNotification extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: R2BucketEventNotificationState, opts?: pulumi.CustomResourceOptions): R2BucketEventNotification;
    /**

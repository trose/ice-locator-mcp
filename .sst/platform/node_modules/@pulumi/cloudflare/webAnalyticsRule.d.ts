 ...
 * ```
 */
export declare class WebAnalyticsRule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebAnalyticsRuleState, opts?: pulumi.CustomResourceOptions): WebAnalyticsRule;
    /**
     * Returns true if the given object is an instance of WebAnalyticsRule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WebAnalyticsRule;
    /**
     * Identifier.
     */
     ...
     */
    readonly inclusive: pulumi.Output<boolean | undefined>;
    /**
     * Whether the rule is paused or not.
     */
    readonly isPaused: pulumi.Output<boolean | undefined>;

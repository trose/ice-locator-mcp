 ...
 * ```
 */
export declare function getZeroTrustDnsLocation(args: GetZeroTrustDnsLocationArgs, opts?: pulumi.InvokeOptions): Promise<GetZeroTrustDnsLocationResult>;
/**
 ...
 * ```
 */
export declare function getZeroTrustDnsLocationOutput(args: GetZeroTrustDnsLocationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZeroTrustDnsLocationResult>;
/**
 * A collection of arguments for invoking getZeroTrustDnsLocation.
 */

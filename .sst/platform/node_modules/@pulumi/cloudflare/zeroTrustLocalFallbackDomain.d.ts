 ...
 */
export declare class ZeroTrustLocalFallbackDomain extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustLocalFallbackDomainState, opts?: pulumi.CustomResourceOptions): ZeroTrustLocalFallbackDomain;
    /**
     ...
     */
    static isInstance(obj: any): obj is ZeroTrustLocalFallbackDomain;
    readonly accountId: pulumi.Output<string>;
    readonly domains: pulumi.Output<outputs.ZeroTrustLocalFallbackDomainDomain[]>;

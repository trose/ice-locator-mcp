 ...
 * ```
 */
export declare function getRateLimit(args: GetRateLimitArgs, opts?: pulumi.InvokeOptions): Promise<GetRateLimitResult>;
/**
 ...
 * ```
 */
export declare function getRateLimitOutput(args: GetRateLimitOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRateLimitResult>;
/**
 * A collection of arguments for invoking getRateLimit.
 */

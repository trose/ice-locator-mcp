 ...
 * ```
 */
export declare class WorkersCustomDomain extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkersCustomDomainState, opts?: pulumi.CustomResourceOptions): WorkersCustomDomain;
    /**
     * Returns true if the given object is an instance of WorkersCustomDomain.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkersCustomDomain;
    /**

...
export declare class AccessCustomPage extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessCustomPageState, opts?: pulumi.CustomResourceOptions): AccessCustomPage;
    /**
     * Returns true if the given object is an instance of AccessCustomPage.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AccessCustomPage;
    /**
     * Identifier.
     */

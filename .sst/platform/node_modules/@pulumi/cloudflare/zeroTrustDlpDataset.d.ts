 ...
 * ```
 */
export declare class ZeroTrustDlpDataset extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustDlpDatasetState, opts?: pulumi.CustomResourceOptions): ZeroTrustDlpDataset;
    /**
     * Returns true if the given object is an instance of ZeroTrustDlpDataset.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ZeroTrustDlpDataset;
     ...
     */
    readonly caseSensitive: pulumi.Output<boolean | undefined>;
    readonly columns: pulumi.Output<outputs.ZeroTrustDlpDatasetColumn[]>;
    readonly createdAt: pulumi.Output<string>;
    readonly dataset: pulumi.Output<outputs.ZeroTrustDlpDatasetDataset>;
     ...
     */
    readonly encodingVersion: pulumi.Output<number | undefined>;
    readonly maxCells: pulumi.Output<number>;
    readonly name: pulumi.Output<string>;
    readonly numCells: pulumi.Output<number>;
    /**
    ...
    readonly uploads: pulumi.Output<outputs.ZeroTrustDlpDatasetUpload[]>;
    /**

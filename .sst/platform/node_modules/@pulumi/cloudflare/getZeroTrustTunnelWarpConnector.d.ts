 ...
 * ```
 */
export declare function getZeroTrustTunnelWarpConnector(args: GetZeroTrustTunnelWarpConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetZeroTrustTunnelWarpConnectorResult>;
/**
 * A collection of arguments for invoking getZeroTrustTunnelWarpConnector.
 */
export interface GetZeroTrustTunnelWarpConnectorArgs {
    /**
 ...
 */
export interface GetZeroTrustTunnelWarpConnectorResult {
    /**
     * Cloudflare account ID
     */
     ...
     */
    readonly connections: outputs.GetZeroTrustTunnelWarpConnectorConnection[];
    /**
    ...
    readonly filter?: outputs.GetZeroTrustTunnelWarpConnectorFilter;
    /**
     * UUID of the tunnel.
     */
    readonly id: string;
 ...
 * ```
 */
export declare function getZeroTrustTunnelWarpConnectorOutput(args: GetZeroTrustTunnelWarpConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZeroTrustTunnelWarpConnectorResult>;
/**
 * A collection of arguments for invoking getZeroTrustTunnelWarpConnector.
 */
export interface GetZeroTrustTunnelWarpConnectorOutputArgs {
    /**
     * Cloudflare account ID
     */

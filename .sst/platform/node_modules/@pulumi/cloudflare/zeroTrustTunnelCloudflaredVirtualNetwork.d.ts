 ...
 * ```
 */
export declare class ZeroTrustTunnelCloudflaredVirtualNetwork extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustTunnelCloudflaredVirtualNetworkState, opts?: pulumi.CustomResourceOptions): ZeroTrustTunnelCloudflaredVirtualNetwork;
    /**
     ...
     */
    static isInstance(obj: any): obj is ZeroTrustTunnelCloudflaredVirtualNetwork;
    /**
     ...
     * If `true`, this virtual network is the default for the account.
     */
    readonly isDefaultNetwork: pulumi.Output<boolean>;
    /**

 ...
 * ```
 */
export declare class CallsSfuApp extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CallsSfuAppState, opts?: pulumi.CustomResourceOptions): CallsSfuApp;
    /**
     * Returns true if the given object is an instance of CallsSfuApp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CallsSfuApp;
    /**

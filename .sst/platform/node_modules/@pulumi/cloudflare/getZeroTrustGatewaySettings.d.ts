 ...
 * ```
 */
export declare function getZeroTrustGatewaySettings(args: GetZeroTrustGatewaySettingsArgs, opts?: pulumi.InvokeOptions): Promise<GetZeroTrustGatewaySettingsResult>;
/**
 ...
 * ```
 */
export declare function getZeroTrustGatewaySettingsOutput(args: GetZeroTrustGatewaySettingsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZeroTrustGatewaySettingsResult>;
/**
 * A collection of arguments for invoking getZeroTrustGatewaySettings.
 */

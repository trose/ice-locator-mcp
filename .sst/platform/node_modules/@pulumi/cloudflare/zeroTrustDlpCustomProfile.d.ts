 ...
 * ```
 */
export declare class ZeroTrustDlpCustomProfile extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustDlpCustomProfileState, opts?: pulumi.CustomResourceOptions): ZeroTrustDlpCustomProfile;
    /**
     ...
     */
    static isInstance(obj: any): obj is ZeroTrustDlpCustomProfile;
    readonly accountId: pulumi.Output<string>;
    readonly aiContextEnabled: pulumi.Output<boolean>;
    /**
     * Related DLP policies will trigger when the match count exceeds the number set.
     */
    readonly allowedMatchCount: pulumi.Output<number>;
    readonly confidenceThreshold: pulumi.Output<string>;
    /**
     * Scan the context of predefined entries to only return matches surrounded by keywords.
     *
     * @deprecated This attribute is deprecated.
     */
    readonly contextAwareness: pulumi.Output<outputs.ZeroTrustDlpCustomProfileContextAwareness | undefined>;
    /**
     ...
     * @deprecated This attribute is deprecated.
     */
    readonly entries: pulumi.Output<outputs.ZeroTrustDlpCustomProfileEntry[] | undefined>;
    readonly name: pulumi.Output<string>;
    readonly ocrEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly sharedEntries: pulumi.Output<outputs.ZeroTrustDlpCustomProfileSharedEntry[] | undefined>;
    /**

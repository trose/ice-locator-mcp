 ...
 * ```
 */
export declare function getZeroTrustDlpCustomProfile(args: GetZeroTrustDlpCustomProfileArgs, opts?: pulumi.InvokeOptions): Promise<GetZeroTrustDlpCustomProfileResult>;
/**
 ...
 * ```
 */
export declare function getZeroTrustDlpCustomProfileOutput(args: GetZeroTrustDlpCustomProfileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZeroTrustDlpCustomProfileResult>;
/**
 * A collection of arguments for invoking getZeroTrustDlpCustomProfile.
 */

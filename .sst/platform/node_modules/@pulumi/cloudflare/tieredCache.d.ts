 ...
 * ```
 */
export declare class TieredCache extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TieredCacheState, opts?: pulumi.CustomResourceOptions): TieredCache;
    /**
     * Returns true if the given object is an instance of TieredCache.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TieredCache;
    /**

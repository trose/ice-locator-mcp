 ...
 * ```
 */
export declare function getWorkersKv(args: GetWorkersKvArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkersKvResult>;
/**
 ...
 * ```
 */
export declare function getWorkersKvOutput(args: GetWorkersKvOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkersKvResult>;
/**
 * A collection of arguments for invoking getWorkersKv.
 */

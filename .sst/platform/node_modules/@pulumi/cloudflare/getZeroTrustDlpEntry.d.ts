 ...
 * ```
 */
export declare function getZeroTrustDlpEntry(args: GetZeroTrustDlpEntryArgs, opts?: pulumi.InvokeOptions): Promise<GetZeroTrustDlpEntryResult>;
/**
 ...
 * ```
 */
export declare function getZeroTrustDlpEntryOutput(args: GetZeroTrustDlpEntryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetZeroTrustDlpEntryResult>;
/**
 * A collection of arguments for invoking getZeroTrustDlpEntry.
 */

 ...
 * ```
 */
export declare function getWorkersKvNamespace(args: GetWorkersKvNamespaceArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkersKvNamespaceResult>;
/**
 ...
 * ```
 */
export declare function getWorkersKvNamespaceOutput(args: GetWorkersKvNamespaceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkersKvNamespaceResult>;
/**
 * A collection of arguments for invoking getWorkersKvNamespace.
 */

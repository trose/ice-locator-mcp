 ...
 * ```
 */
export declare class WorkersKvNamespace extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkersKvNamespaceState, opts?: pulumi.CustomResourceOptions): WorkersKvNamespace;
    /**
     * Returns true if the given object is an instance of WorkersKvNamespace.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkersKvNamespace;
    /**
     * Identifier.
     */
     ...
     */
    readonly supportsUrlEncoding: pulumi.Output<boolean>;
    /**

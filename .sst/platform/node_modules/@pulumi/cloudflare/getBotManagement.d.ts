 ...
 * ```
 */
export declare function getBotManagement(args: GetBotManagementArgs, opts?: pulumi.InvokeOptions): Promise<GetBotManagementResult>;
/**
 ...
 * ```
 */
export declare function getBotManagementOutput(args: GetBotManagementOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBotManagementResult>;
/**
 * A collection of arguments for invoking getBotManagement.
 */

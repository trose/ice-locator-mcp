 ...
 * ```
 */
export declare class ZeroTrustGatewaySettings extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZeroTrustGatewaySettingsState, opts?: pulumi.CustomResourceOptions): ZeroTrustGatewaySettings;
    /**
     * Returns true if the given object is an instance of ZeroTrustGatewaySettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ZeroTrustGatewaySettings;

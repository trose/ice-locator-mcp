 ...
 * ```
 */
export declare function getAccountMember(args: GetAccountMemberArgs, opts?: pulumi.InvokeOptions): Promise<GetAccountMemberResult>;
/**
 ...
 * ```
 */
export declare function getAccountMemberOutput(args: GetAccountMemberOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAccountMemberResult>;
/**
 * A collection of arguments for invoking getAccountMember.
 */
